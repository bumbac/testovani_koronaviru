...
class PatientLoginView(View):
    """!
    View controller class that implements GET and POST methods for PatientLoginView
    """
    form = LoginForm
    ...
    def get(self, request):
        ...
        @return: render method, which renders the PatientLogin html template with a form
        """
    ...
    def post(self, request):
        ...
        @param request: request
        @return: Redirect to Patient's site, if the login was successful, otherwise render method which renders the same page again
        """
